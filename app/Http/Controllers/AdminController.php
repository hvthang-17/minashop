...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $dashboarDatas = DB::select("Select sum(total) As TotalAmount,
    ...
    $TotalCanceledAmount = collect($monthlyDatas)->sum("TotalCanceledAmount");
        ...
        return view('admin.index', compact('orders', 'dashboarDatas', 'AmountM', 'OrderedAmountM', 'DeliveredAmountM', 'CanceledAmountM', 'TotalAmount', 'TotalOrderedAmount', 'TotalDeliveredAmount', 'TotalCanceledAmount'));
    }
    ...
    public function category_update(Request $request)
    {
        ...
        $category->save();
        return redirect()->route('admin.categories')->with('status', 'Thương hiệu đã được cập nhật thành công!');
    }
    ...
    public function category_delete($id){
        ...
        $category->delete();
        return redirect()->route('admin.categories')->with('status', 'Thương hiệu đã được xóa thành công!');
    }
    ...
    public function coupon_store(CouponRequest $request)
    {
        ...
        $coupon->save();
        return redirect()->route('admin.coupons')->with('status','Mã giảm giá đã được thêm thành công!');
    }
    ...
    public function update_order_status(Request $request)
    {
        ...
        return back()->with('status', 'Trạng thái đã được thay đổi thành công!');
    }
    ...
    public function slide_store(SlideRequest $request)
    {
        $slide = new Slide();
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with('status','Slide đã được thêm thành công!');
    }
    ...
    public function slide_update(SlideRequest $request)
    {
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with('status','Slide đã được cập nhật thành công!');
    }
    ...
    public function slide_delete($id)
    {
        ...
        $slide->delete();
        return redirect()->route('admin.slides')->with('status','Slide đã được xóa thành công!');
    }
    ...
    public function contact_delete($id)
    {
        ...
        $contact->delete();
        return redirect()->route('admin.contacts')->with('status','Liên hệ đã được xóa thành công!');
    }
    ...
    {
        $lists = User::orderBy("created_at","desc")->paginate(10);
        $totalOrdersData = DB::select("SELECT COUNT(*) AS TotalOrders FROM Orders");
        $totalOrders = $totalOrdersData[0]->TotalOrders ?? 0;
        return view('admin.users', compact("lists","totalOrders"));
    }

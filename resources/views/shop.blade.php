...
@section('content')
    <style>
        ...
        .swiper-slide-active .slide-split_text {
            opacity: 1;
        }
    </style>
    ...
    <main class="pt-90">
        <section class="shop-main container d-flex pt-4 pt-xl-5">
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="100" data-slider-max="900" data-slider-step="5"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                ...
                                <div>
                                    ...
                                    <span class="price-range__max">$900</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="shop-list flex-grow-1">
                ...
                <div class="slide-shop swiper-container js-swiper-slider slideshow slideshow_split"
                    data-settings='{
            "autoplay": {
              "delay": 5000
            },
              ...
              "clickable": true
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="slide-split slideshop-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_media slideshop-media position-relative">
                                    <div class="slideshow-bg slideshop-bg"
                                        style="background-image: url(https://cdn.shopify.com/s/files/1/0697/0775/9932/files/shop_access_between_bg.jpg); background-size: cover; background-position: center;">
                                        <div
                                            class="slide-split_text position-absolute top-50 start-50 translate-middle text-center text-white">
                                            <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2 text-white"
                                                style="font-size: 1.9rem; line-height: 1.2;">
                                                Đồ cổ <br /><strong>TT ANTIQUES</strong>
                                            </h2>
                                            <p class="mb-0 animate animate_fade animate_btt animate_delay-5">
                                                Khám phá vẻ đẹp vượt thời gian trong từng món đồ cổ. Từ giá trị lịch sử đến
                                                nghệ thuật tinh hoa, chúng tôi mang đến những tác phẩm độc đáo dành riêng
                                                cho bạn.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="slide-split slideshop-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_media slideshop-media position-relative">
                                    <div class="slideshow-bg slideshop-bg"
                                        style="background-image: url('assets/images/shop/shop_banner4.jpg'); background-size: cover; background-position: center;">
                                        <div
                                            class="slide-split_text position-absolute top-50 start-50 translate-middle text-center text-white">
                                            <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2 text-white"
                                                style="font-size: 1.9rem; line-height: 1.2;">
                                                Nghệ thuật<br /><strong>VƯỢT THỜI GIAN</strong>
                                            </h2>
                                            <p class="mb-0 animate animate_fade animate_btt animate_delay-5">
                                                Mỗi món đồ cổ là một câu chuyện, một mảnh ghép của lịch sử và văn hóa, chờ
                                                đợi được khám phá và trân trọng.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="slide-split slideshop-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_media slideshop-media position-relative">
                                    <div class="slideshow-bg slideshop-bg"
                                        style="background-image: url('assets/images/shop/shop_banner5.jpg'); background-size: cover; background-position: center;">
                                        <div
                                            class="slide-split_text position-absolute top-50 start-50 translate-middle text-center text-white">
                                            <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2 text-white"
                                                style="font-size: 1.9rem; line-height: 1.2;">
                                                Tinh hoa <br /><strong>ĐỒ CỔ</strong>
                                            </h2>
                                            <p class="mb-0 animate animate_fade animate_btt animate_delay-5">
                                                Gìn giữ di sản, truyền cảm hứng qua những món đồ cổ độc đáo và mang đậm dấu
                                                ấn thời gian.
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Page Size" id="pagesize" name="size" style="margin-right:20px">
                                ...
                                <div class="pc__img-wrapper">
                                    ...
                                    @if (Cart::instance('cart')->content()->where('id', $product->id)->count() > 0)
                                        <a href="{{ route('cart.index') }}"
                                            class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning mb-3">Đến
                                            giỏ hàng</a>
                                    @else
                                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                            ...
                                            <button type="submit"
                                                ...
                                                data-aside="cartDrawer" title="Thêm vào giỏ hàng">Thêm vào giỏ
                                                hàng</button>
                                        </form>
                                    @endif
                                </div>

            ...
            <div class="mw-930">
                <div class="contact-us__form">
                    ...
                    <form name="contact-us-form" class="needs-validation" novalidate="" action="{{route('home.contact.store')}}" method="POST">
                        @csrf
                        <h3 class="mb-5">Hãy đóng góp ý kiến của bạn</h3>
                        ...
                        <div class="my-4">
                            <textarea class="form-control form-control_gray" name="comment" placeholder="Tin nhắn của bạn" cols="30" rows="8" required="">{{old('comment')}}</textarea>

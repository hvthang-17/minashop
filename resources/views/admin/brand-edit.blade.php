            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{route('admin.brands')}}">
                        <div class="text-tiny">Các thương hiệu</div>
                    </a>
                </li>
                <li>
                    <i class="icon-chevron-right"></i>
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.brand.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Tên thương hiệu" name="name"
                        tabindex="0" value="{{$brand->name}}" aria-required="true">
                </fieldset>
                @error('name') <span class="alert alert-danger fs-5"><strong>{{ $message }}</strong></span>
                @enderror
                <fieldset class="name">
                    <div class="body-title">Slug thương hiệu <span class="tf-color-1">*</span></div>
                    <input class="flex-grow" type="text" placeholder="Slug thương hiệu" name="slug"
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div id="upload-file" class="item up-load">
                            <label class="uploadfile" for="myFile">
                                ...
                                <span class="body-text">Kéo thả ảnh tại đây hoặc chọn <span

        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST" action="{{route('admin.coupon.update')}}">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Mã giảm giá" name="code" tabindex="0" value="{{$coupon->code}}" aria-required="true">
                </fieldset>
                ...
                <fieldset class="category">
                    ...
                    <div class="select flex-grow">
                        <select class="" name="type">
                            ...
                            <option value="Cố định" {{ $coupon->type == 'Cố định' ? 'selected' : ''}}>Cố định</option>
                            <option value="Phần trăm" {{ $coupon->type == 'Phần trăm' ? 'selected' : ''}}>Phần trăm</option>
                        </select>
                    </div>
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Giá trị mã giảm giá" name="value" tabindex="0" value="{{$coupon->value}}" aria-required="true">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Giá trị giỏ hàng" name="cart_value" tabindex="0" value="{{$coupon->cart_value}}" aria-required="true">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="date" placeholder="Ngày hết hạn" name="expiry_date" tabindex="0" value="{{$coupon->expiry_date}}" aria-required="true">
                </fieldset>

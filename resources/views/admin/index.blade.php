                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboarDatas[0]->TotalAmount }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboarDatas[0]->TotalOrdered }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboarDatas[0]->TotalOrderedAmount }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboarDatas[0]->TotalDelivered }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboarDatas[0]->TotalDeliveredAmount }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboarDatas[0]->TotalCanceled }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wg-chart-default">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Tổng số tiền đơn hàng đã hủy</div>
                                        <h4>{{ $dashboarDatas[0]->TotalCanceledAmount }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wg-box">
                    ...
                    <div class="flex flex-wrap gap40">
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    <div class="dot t1 bg-warning"></div>
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    <div class="dot t1 bg-success"></div>
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    <div class="dot t1 bg-danger"></div>

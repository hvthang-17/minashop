...
@section('content')
    ...
    <main class="pt-90">
                    ...
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        ...
                        <div
                            ...
                            <a href="#" class="text-uppercase fw-medium"><svg width="10" height="10"
                                ...
                                </svg><span class="menu-link menu-link_us-s"></span></a>
                            <a href="#" class="text-uppercase fw-medium"><span
                                    class="menu-link menu-link_us-s"></span><svg width="10" height="10"
                                    viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-additional-info" role="tabpanel"
                        ...
                        <div class="product-single__addtional-info">
                            ...
                            <div class="item">
                                <label class="h6">Trình trạng sản phẩm:</label>
                                <span>{{ $product->stock_status}}</span>
                            </div>
                            <div class="item">
                                <label class="h6">Số lượng sản phẩm có:</label>
                    ...
                    <div class="tab-pane fade" id="tab-reviews" role="tabpanel" aria-labelledby="tab-reviews-tab">
                            ...
                            @foreach ($product->comments as $comment)
                                <div class="product-single__reviews-item">
                                    <div class="customer-avatar">
                                        <img loading="lazy" src="assets/images/avatar.jpg" alt="Avatar của khách hàng" />
                                    </div>
                                    <div class="customer-review">
                                        ...
                                        <div class="review-date">{{ $comment->created_at->format('d/m/Y') }}</div>
                        ...
                        <div class="product-single__review-form">
                            <form name="customer-review-form" action="{{ route('comments.store', $product->id) }}" method="POST">
                                @csrf
                                <h5>Hãy là người đầu tiên đánh giá sản phẩm</h5>
                                ...
                                <div class="mb-4">
                                    <textarea id="form-input-review" name="review" class="form-control form-control_gray" cols="30" rows="8"></textarea>
                                </div>
                                ...
                                <div class="form-label-fixed mb-4">
                                    ...
                                    <input id="form-input-email" name="email" class="form-control form-control-md form-control_gray" required>
                                </div>
                                <div class="form-check mb-4">
                                    <input class="form-check-input form-check-input_fill" type="checkbox" value="" id="remember_checkbox">
                                    <label class="form-check-label" for="remember_checkbox">
                                        Lưu họ và tên, email và trang web của tôi trên trình duyệt này cho lần bình luận
                                        tiếp theo.
                                    </label>
                                </div>
        ...
        <section class="products-carousel container">
            <h2 class="h3 mb-4 pb-xl-2 mb-xl-4">Sản phẩm liên quan</h2>
                                ...
                                <div class="pc__img-wrapper">
                                    ...
                                    @if (Cart::instance('cart')->content()->where('id', $rproduct->id)->count() > 0)
                                        <a href="{{ route('cart.index') }}"
                                            class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning mb-3">Đến giỏ hàng</a>
                                    @else

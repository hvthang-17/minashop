                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <div class="text">Các sản phẩm</div>
                                    </a>
                                    <ul class="sub-menu">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.brands') }}" class="">
                                                <div class="text">Các thương hiệu</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.categories') }}" class="">
                                                <div class="text">Các danh mục</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.orders') }}" class="">
                                                <div class="text">Các đơn hàng</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="section-content-right">
                        ...
                        <div class="wrap">
                            <div class="header-left">
                                ...
                                <form class="form-search flex-grow">
                                    <fieldset class="name">
                                        <input type="text" placeholder="Tìm kiểm tại đây..." class="show-search" name="name" id="search-input" tabindex="2" value="" aria-required="true" required="" autocomplete="off">
                                    </fieldset>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 TT Antiques</div>
                        </div>
                    </div>
